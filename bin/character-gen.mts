...
const isCharacter = (c: string) => (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z')
const isWord = (c: string) => '_-?'.includes(c) || isCharacter(c) || isNumber(c)
const isBlank = (c: string) => '\n\t \r\v\f'.includes(c)
const isInlineBlank = (c: string) => c === '\t' || c === ' ' || c === '\r'
...
//
// This file is generated by bin/character-gen.mts
