...
describe('Static analysis', () => {
  it('should report variables from non-standard tags', async () => {
  ...
  it('should export analysis interfaces', async () => {
    const engine = new Liquid()
    const template = engine.parse('{% include nothing %}')
    const options: StaticAnalysisOptions = { partials: false }
    const analysis: StaticAnalysis = await analyze(template, options)
